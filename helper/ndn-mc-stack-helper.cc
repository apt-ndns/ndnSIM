...
NS_LOG_COMPONENT_DEFINE ("ndn.McStackHelper");

namespace ns3 {
namespace ndn {

McStackHelper::McStackHelper ()
  : m_limitsEnabled (false)
  , m_needSetDefaultRoutes (false)
{
  m_ndnFactory.         SetTypeId ("ns3::ndn::L3Protocol");
  m_strategyFactory.    SetTypeId ("ns3::ndn::fw::trForwarding");
...
void
McStackHelper::SetStackAttributes (const std::string &attr1, const std::string &value1,
...
void
McStackHelper::SetForwardingStrategy (const std::string &strategy,
...
void
McStackHelper::SetContentStore (const std::string &contentStore,
                              const std::string &attr1, const std::string &value1,
                              const std::string &attr2, const std::string &value2,
                              const std::string &attr3, const std::string &value3,
                              const std::string &attr4, const std::string &value4)
...
void
McStackHelper::SetPit (const std::string &pitClass,
                     const std::string &attr1, const std::string &value1,
                     const std::string &attr2, const std::string &value2,
                     const std::string &attr3, const std::string &value3,
                     const std::string &attr4, const std::string &value4)
...
void
McStackHelper::SetMc (const std::string &mcClass,
                      const std::string &attr1, const std::string &value1,
                      const std::string &attr2, const std::string &value2,
                      const std::string &attr3, const std::string &value3,
                      const std::string &attr4, const std::string &value4)
{
  ...
  if (attr2 != "")
      m_mcFactory.Set (attr2, StringValue (value2));
  if (attr3 != "")
      m_mcFactory.Set (attr3, StringValue (value3));
  if (attr4 != "")
      m_mcFactory.Set (attr4, StringValue (value4));
}

void
McStackHelper::SetFib (const std::string &fibClass,
                     const std::string &attr1, const std::string &value1,
                     const std::string &attr2, const std::string &value2,
                     const std::string &attr3, const std::string &value3,
                     const std::string &attr4, const std::string &value4)
...
void
McStackHelper::SetDefaultRoutes (bool needSet)
{
...
void
McStackHelper::EnableLimits (bool enable/* = true*/,
...
Ptr<FaceContainer>
McStackHelper::Install (const NodeContainer &c) const
{
...
Ptr<FaceContainer>
McStackHelper::InstallAll () const
{
  return Install (NodeContainer::GetGlobal ());
}

Ptr<FaceContainer>
McStackHelper::Install (Ptr<Node> node) const
{
  ...
  if (node->GetObject<L3Protocol> () != 0)
    {
      NS_FATAL_ERROR ("McStackHelper::Install (): Installing "
  ...
  ndn->AggregateObject (m_mcFactory.Create<Mc> ());
...
void
McStackHelper::AddNetDeviceFaceCreateCallback (TypeId netDeviceType, McStackHelper::NetDeviceFaceCreateCallback callback)
{
  m_netDeviceCallbacks.push_back (std::make_pair (netDeviceType, callback));
}

void
McStackHelper::UpdateNetDeviceFaceCreateCallback (TypeId netDeviceType, NetDeviceFaceCreateCallback callback)
{
...
void
McStackHelper::RemoveNetDeviceFaceCreateCallback (TypeId netDeviceType, NetDeviceFaceCreateCallback callback)
{
  for (NetDeviceCallbackList::iterator i = m_netDeviceCallbacks.begin (); i != m_netDeviceCallbacks.end (); i++)
    {
      if (i->first == netDeviceType)
...
Ptr<NetDeviceFace>
McStackHelper::DefaultNetDeviceCallback (Ptr<Node> node, Ptr<L3Protocol> ndn, Ptr<NetDevice> netDevice) const
{
...
Ptr<NetDeviceFace>
McStackHelper::PointToPointNetDeviceCallback (Ptr<Node> node, Ptr<L3Protocol> ndn, Ptr<NetDevice> device) const
{
...
Ptr<FaceContainer>
McStackHelper::Install (const std::string &nodeName) const
{
...
void
McStackHelper::AddRoute (Ptr<Node> node, const std::string &prefix, Ptr<Face> face, int32_t metric)
{
...
void
McStackHelper::AddRoute (Ptr<Node> node, const std::string &prefix, uint32_t faceId, int32_t metric)
{
...
void
McStackHelper::AddRoute (const std::string &nodeName, const std::string &prefix, uint32_t faceId, int32_t metric)
{
  Ptr<Node> node = Names::Find<Node> (nodeName);
...
void
McStackHelper::AddRoute (Ptr<Node> node, const std::string &prefix, Ptr<Node> otherNode, int32_t metric)
{
...
void
McStackHelper::AddRoute (const std::string &nodeName, const std::string &prefix, const std::string &otherNodeName, int32_t metric)
{
  Ptr<Node> node = Names::Find<Node> (nodeName);
  NS_ASSERT_MSG (node != 0, "Node [" << nodeName << "] does not exist");
